...
class CreateUserAdaptersTest extends TestCase
{
    ...
    public function testCliPresenter(array $data)
    {
        ...
        $this->assertInstanceof(CliIViewModel::class, $viewModel);
    ...
    private function mockUser(array $data): IUserEntity
    {
    ...
    private function mockCreateUserResponseModel(IUserEntity $user): CreateUserResponseModel
    {
